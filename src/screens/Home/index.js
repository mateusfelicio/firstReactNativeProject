    ...
    return (
        ...
        <View style={styles.container}>
            ...
            <ScrollView showVerticalScrollIndicator={false} style={styles.contentMovies}>
                ...
                <TouchableOpacity style={styles.movieImageThumbail}>
                ...
                <FlatList
                    ...
                    renderItem={({item}) => <MoviesCards movieURL={item.moviesURL} />}
                    horizontal
                ...
                <Text style={styles.movieText}>Watch in yout language</Text>
                <FlatList
                    data={MOVIESWATCH}
                    keyExtractor={(item) => item.id}
                    renderItem={({item}) => <MoviesCards movieURL={item.moviesURL} />}
